...
String cans="Ball";
    ...
    private void initComponents() {
        ...
        jTextField1.setText("L E V E L - 4");
        jTextField1.setEnabled(false);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/ball4.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/ball1.jpg"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/ball2.jpg"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/ball.jpg"))); // NOI18N
...
int Rs=Integer.parseInt(jLabel3.getText()); int Rsot=Rs;
  ...
  if (( ( anst=='L' || anst=='l' ) && ( ansa=='L' || ansa=='l' ) && ( ansb=='A' || ansb=='a' ) && ( ansd=='B' || ansd=='b' )) )
    { JOptionPane.showMessageDialog(null,"CONGRATULATION"
            + "\n you will be on 5th LEVEL. \n \t PROCEED");
        new L5 (name,Rs).setVisible(true);dispose();
     }
  else 
  {new gameover (name,Rsot,cans,tout).setVisible(true);dispose();}
...
{JOptionPane.showMessageDialog(null,"something went wrong. \n"+e);}// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
