...
public class L3 extends javax.swing.JFrame {
  ...
  String cans="Bat";
    ...
    private void initComponents() {
        ...
        jTextField1.setText("L E V E L - 3");
        jTextField1.setEnabled(false);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/can3.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/can1.jpg"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/can2.jpg"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/can.jpg"))); // NOI18N
...
int Rs=Integer.parseInt(jLabel3.getText()); int Rsot=Rs;
  ...
  if (( ( anst=='N' || anst=='n' ) && ( ansa=='A' || ansa=='a' ) && ( ansb=='C' || ansb=='c' )) )
    { JOptionPane.showMessageDialog(null,"CONGRATULATION"
            + "\n you will be on 4th LEVEL. \n \t PROCEED");
        new L4 (name,Rs).setVisible(true);dispose();
     }
  else 
  {new gameover (name,Rsot,cans,tout).setVisible(true);dispose();}
