 ...
 * @author sony
 */
public class L9 extends javax.swing.JFrame {
  ...
  String cans="Bat";
    ...
    private void initComponents() {
        ...
        jTextField1.setText("L E V E L - 9");
        jTextField1.setEnabled(false);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/fish3.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/fish1.jpg"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/fish2.jpg"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/fish.jpg"))); // NOI18N
...
int Rs=Integer.parseInt(jLabel3.getText()); int Rsot=Rs;
  ...
  if (( ( anst=='h' || anst=='H' ) && ( ansa=='s' || ansa=='S' ) && ( ansb=='i' || ansb=='I' ) && ( ansd=='F' || ansd=='f' )) )
    { JOptionPane.showMessageDialog(null,"CONGRATULATION"
            + "\n you will be on 10th LEVEL. \n \t PROCEED");
        new L10 (name,Rs).setVisible(true);dispose();
     }
  else 
  {new gameover (name,Rsot,cans,tout).setVisible(true);dispose();}
...
{JOptionPane.showMessageDialog(null,"something went wrong. \n"+e);}// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
