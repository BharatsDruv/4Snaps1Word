 ...
 * @author sony
 */
public class L13 extends javax.swing.JFrame {
 ...
 Rs+=10; int Rsot=Rs;
    ...
    private void initComponents() {
        ...
        jTextField1.setText("L E V E L - 13");
        jTextField1.setEnabled(false);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/full3.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/full1.jpg"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/full2.jpg"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/full.jpg"))); // NOI18N
...
{  String cans="Full"; String tout="G A M E - O V E R";
...
int Rs=Integer.parseInt(jLabel3.getText()); int Rsot=Rs;
  ...
  if ( ( ansd=='l' || ansd=='L' ) && ( ansl=='l' || ansl=='L' ) && ( anso=='u' || anso=='U' ) && ( ansc=='F' || ansc=='f' )) 
    {
         new tressure(name,Rs).setVisible(true);
...
{JOptionPane.showMessageDialog(null,"something went wrong. \n"+e);}        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
