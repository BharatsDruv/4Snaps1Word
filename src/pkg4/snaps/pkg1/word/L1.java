...
int Rs=0; int Rsot=Rs;
    ...
    private void initComponents() {
        ...
        jTextField1.setText("L E V E L - 1");
        jTextField1.setEnabled(false);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/green3.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/green1.jpg"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/green2.jpg"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/green.jpg"))); // NOI18N
        ...
        jLabel23.setText("What simple word this snaps are representing");
...
int Rs=Integer.parseInt(jLabel3.getText()); int Rsot=Rs;
  ...
  else
  {
   ...
   char ansbc=ans.charAt(len-4);
    char ansbcd=ans.charAt(len-5);
   
  
  
  if (( ( anst=='N' || anst=='n' ) && ( ansa=='E' || ansa=='e' ) && ( ansb=='E' || ansb=='e' ) 
          && ( ansbc=='R' || ansbc=='r' ) && ( ansbcd=='G' || ansbcd=='g' ) ) )
    { JOptionPane.showMessageDialog(null,"CONGRATULATION"
            + "\n you will be on 2nd LEVEL. \n \t PROCEED");
        new L2(name,Rs).setVisible(true);dispose();
     }
  else 
  {new gameover (name,Rsot,cans,tout).setVisible(true);dispose();}
