 ...
 * @author sony
 */
public class L11 extends javax.swing.JFrame {
...
String cans="Cold";
 Rs+=10; int Rsot=Rs;
    ...
    private void initComponents() {
        ...
        jTextField1.setText("L E V E L - 11");
        jTextField1.setEnabled(false);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/alarm3.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/alarm1.jpg"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/alarm2.jpg"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4/snaps/pkg1/word/alarm.jpg"))); // NOI18N
...
{  String cans="Alarm"; String tout="G A M E - O V E R";
...
int Rs=Integer.parseInt(jLabel3.getText()); int Rsot=Rs;
  ...
  if ( ( ansd=='m' || ansd=='M' ) && ( ansl=='R' || ansl=='r' ) && ( anso=='a' || anso=='A' ) && ( ansc=='l' || ansc=='L' ) && ( anse=='a' || anse=='A' )) 
    {JOptionPane.showMessageDialog(null,"CONGRATULATION"
            + "\n you will be on 12th LEVEL. \n \t PROCEED");
        new L12 (name,Rs).setVisible(true);dispose();
...
{JOptionPane.showMessageDialog(null,"something went wrong. \n"+e);}        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
